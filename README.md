...
[![Tests](https://img.shields.io/badge/tests-1444%20passed-brightgreen)]()
...
### v2.2.0 — Composite Game-Object Tools + Ghostworks Pipeline + Ghostworks Pipeline
...
| **MCP Server** | 27 tools over `stdio`, HTTP, or SSE; usable from Claude Desktop, Cursor, VS Code Copilot, or any MCP-compatible agent |
...
```
 ...
 │   MCP server (27 tools)    3D object placement GLTF/OBJ import       │
...
# 1444 passed, 6 skipped in ~7 seconds
```
...
- [x] **MCP server** — 27 tools, 3 transport modes (stdio / HTTP / SSE), full KotOR API surface for AI agents
